...
import TrendSummary from '@/src/components/analytics/trendsummary';
import DateRangeFilter from '@/src/components/analytics/daterangefilter';

import PredictiveOverview from '@/src/components/predictions/predictionoverview';
import ForecastChart from '@/src/components/predictions/forecastchart';
import AnomalyPanel from '@/src/components/predictions/anomalypanel';
